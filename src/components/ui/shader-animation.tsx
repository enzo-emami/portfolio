...
export function ShaderAnimation() {
  ...
  useEffect(() => {
    ...
    // Fragment shader
    // mouse/hover: cursor-reactive glow layered on top of the base pattern.
    const fragmentShader = `
      ...
      void main(void) {
        ...
        // cursor glow: warm highlight that follows the pointer and fades on leave
        float d = length(uv - muv);
        float glow = hover * 0.09 / (d + 0.045);
        color += glow * vec3(0.35, 0.45, 0.9);
